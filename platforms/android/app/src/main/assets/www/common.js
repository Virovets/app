...
let DataService = class DataService {
    ...
    getSearchItems(search) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(this.items).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(d => d.filter((item) => (item.name.toLowerCase().indexOf(search.toLowerCase()) > -1))));
    }
};
